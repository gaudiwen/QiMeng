 ...
 * 描述: 电脑桌面的
 * 邮箱：275634247@qq.com
 * Created by GaudiWen on 2019/7/23 17:29.
 */
public class LaucherDataBean2 {

    private List<LaucherBean> JobSalarys;

    public List<LaucherBean> getJobSalarys() {
        return JobSalarys;
    }

    public void setJobSalarys(List<LaucherBean> JobSalarys) {
        this.JobSalarys = JobSalarys;
    }

    public static class LaucherBean {
        /**
